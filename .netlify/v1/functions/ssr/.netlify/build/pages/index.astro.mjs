...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Entrenador Personal en San Juan | Carlos Aguilera</title><meta name="description" content="Entrenador personal en San Juan. Planes personalizados, clases grupales, asesoramiento en fitness y nutrici\xF3n. \xA1Comienza tu transformaci\xF3n con Carlos Aguilera!"><meta name="keywords" content="entrenador personal, fitness, San Juan, entrenamiento personalizado, clases grupales, nutrici\xF3n, gym, Carlos Aguilera"><meta name="author" content="Carlos Aguilera"><meta property="og:title" content="Entrenador Personal en San Juan | Carlos Aguilera"><meta property="og:description" content="Entrenador personal en San Juan. Planes personalizados, clases grupales, asesoramiento en fitness y nutrici\xF3n."><meta property="og:type" content="website"><meta property="og:url" content="https://tusitioweb.com"><meta property="og:image" content="/assets/Logo.webp"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Entrenador Personal en San Juan | Carlos Aguilera"><meta name="twitter:description" content="Entrenador personal en San Juan. Planes personalizados, clases grupales, asesoramiento en fitness y nutrici\xF3n."><meta name="twitter:image" content="/assets/Logo.webp"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link href="https://cdn.jsdelivr.net/npm/flowbite@3.1.2/dist/flowbite.min.css" rel="stylesheet"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Anton&family=Bebas+Neue&family=Bitcount+Grid+Double:wght@100..900&family=Bungee&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet"><meta name="generator"', ">", "</head> <body> ", " ", " ", ' <script src="https://cdn.jsdelivr.net/npm/flowbite@3.1.2/dist/flowbite.min.js"><\/script> </body> </html> '])), addAttribute(Astro2.generator, "content"), renderHead(), renderComponent($$result, "Navbar", $$Navbar, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "ContactForm", $$ContactForm, {}));
